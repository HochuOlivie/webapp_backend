...
const CustomerMap = (props) => {
    ...
    return (
        <div ref={mainRef} style={{height: '100%', width: '100%'}}>
            <YMaps query={{ load: ['ObjectManager', 'Placemark', 'geolocation'], apikey: '4240729e-72a9-4ece-815e-704470532e85' }}>
                <Map defaultState={{
            ...
            <Search city={city} drawerText={drawerText} setDrawerText={setDrawerText} map={map} ymaps={ymaps} objectManager={objectManager} currentFeatures={currentFeatures} setCurrentFeatures={setCurrentFeatures} />
